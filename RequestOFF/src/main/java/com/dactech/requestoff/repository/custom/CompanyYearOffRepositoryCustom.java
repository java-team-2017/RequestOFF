...
public interface CompanyYearOffRepositoryCustom {
	...
	public List<CompanyYearOff> getCompanyYearOffOfCurrentYearAndNextYear(CompanyYearOffCurrentAndNextYearSearchRequest companyYearOffCurrentAndNextYearSearchRequest);
}
